                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="../images/berita/<?= $berita_row["gambar"]; ?>" alt=""
                                                            style="width: 300px; height: 300px;"></td>
                                                    <td>
                                                        <button type="button"
                                                            class="btn btn-outline-primary btn-icon-text">
                                                            <a href="../function/edit_berita.php?id_berita=<?= $berita_row["id_berita"] ?>"
                                                                class="edit">Edit</a></button> ||
                                                        <button type="button"
                                                            class="btn btn-outline-danger btn-icon-text">
                                                            <a href="../function/hapus_berita.php?id_berita=<?= $berita_row["id_berita"] ?>"
