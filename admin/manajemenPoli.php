                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="../images/service/<?= $poli_row["image"]; ?>" alt=""
                                                            style="width: 300px; height: 300px;"></td>
                                                    </td>
                                                    <td>
                                                        <button type="button"
                                                            class="btn btn-outline-primary btn-icon-text">
                                                            <a href="../function/edit_poli.php?id_poli=<?= $poli_row["id_poli"] ?>"
                                                                class="edit">Edit</a> </button> ||
                                                        <button type="button"
                                                            class="btn btn-outline-danger btn-icon-text">
                                                            <a href="../function/hapus_poli.php?id_poli=<?= $poli_row["id_poli"] ?>"
                                                                class="hapus">Hapus</a>
                                                        </button>
                                                    </td>
                                                </tr>
