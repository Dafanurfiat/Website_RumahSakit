            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-title">
                        ...
                        <p>Kami menyediakan berbagai layanan medis dengan spesialisasi di berbagai bidang, didukung oleh
                            tim dokter profesional dan berpengalaman. Kami berkomitmen untuk memberikan perawatan
                            terbaik bagi pasien dengan pendekatan yang penuh perhatian.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="btn-group btn-group-toggle " data-toggle="buttons">
                    ...
                    <label class="btn ">
                        <input type="radio" name="shuffle-filter"
                            value="cat<?= $poli['id_poli'] ?>" /><?= htmlspecialchars($poli['nama_poli']) ?>
                    </label>
                    <?php endwhile; ?>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups='["cat<?= $dokter['id_poli'] ?>"]'
                    ...
                    <div class="position-relative doctor-inner-box">
                        ...
                        <div class="content mt-3">
                            <h4 class="mb-0"><a
                                    href="dokterSingle.php?id_dokter=<?=$dokter['id_dokter'] ?>"><?= htmlspecialchars($dokter['nama_dokter']) ?></a>
                            </h4>
                            <p> <?php $poli = mysqli_fetch_assoc(mysqli_query($conn, "SELECT nama_poli FROM poli WHERE id_poli = {$dokter['id_poli']}")); echo htmlspecialchars($poli['nama_poli']);?>
                            </p>
                        </div>
                    </div>
                </div>
