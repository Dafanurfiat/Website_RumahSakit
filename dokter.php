    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Semua Dokter</span>
  	  ...
  	  <div class="row justify-content-center">
             <div class="col-lg-6 text-center">
                <div class="section-title">
                    ...
                    <p>Kami menyediakan berbagai layanan medis dengan spesialisasi di berbagai bidang, didukung oleh tim dokter profesional dan berpengalaman. Kami berkomitmen untuk memberikan perawatan terbaik bagi pasien dengan pendekatan yang penuh perhatian.</p>
                </div>
            </div>
        </div>
