							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<select class="form-control" id="dokter-select" name="id_dokter" onchange="updateJadwal()">
								...
								<!-- Tombol Submit -->
								<div class="col-lg-12">
									<button type="submit" name="submit" class="btn btn-main btn-round-full">Membuat Janji</button>
								</div>
							</div>
						</form>
