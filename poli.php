            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    <div class="section-title">
                        <h2>Poli Pelayanan Terbaik</h2>
                        <div class="divider mx-auto my-4"></div>
                        <p>Kami menyediakan layanan di berbagai poli yang telah meraih penghargaan untuk perawatan
                            pasien yang luar biasa. Dengan fasilitas medis modern dan tenaga medis ahli, kami
                            berkomitmen untuk memberikan pelayanan terbaik. Setiap poli kami hadirkan untuk memastikan
                            kenyamanan dan perhatian penuh pada kebutuhan kesehatan Anda.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="department-block mb-5">
                        <img src="images/service/<?= htmlspecialchars($poli["image"]) ?>" alt=""
                            class="img-fluid w-100">
                        <div class="content">
                            <h4 class="mt-4 mb-2 title-color"><?= htmlspecialchars($poli["nama_poli"]) ?></h4>
                            <p class="mb-4"><?= htmlspecialchars($poli["deskripsi_poli"]) ?></p>
                            <a href="poliSingle.php?id_poli=<?=$poli['id_poli'] ?>" class="read-more">Learn More <i
