    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Semua Poli</span>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<p>Kami menyediakan layanan di berbagai poli yang telah meraih penghargaan untuk perawatan pasien yang luar biasa. Dengan fasilitas medis modern dan tenaga medis ahli, kami berkomitmen untuk memberikan pelayanan terbaik. Setiap poli kami hadirkan untuk memastikan kenyamanan dan perhatian penuh pada kebutuhan kesehatan Anda.</p>
				</div>
			</div>
		</div>
