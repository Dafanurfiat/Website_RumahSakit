...
<section class="section about-page">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				<p>Kami berkomitmen untuk memberikan perawatan terbaik yang mendukung gaya hidup sehat Anda. Dengan pendekatan yang personal dan penuh perhatian, kami memastikan setiap kebutuhan kesehatan Anda dipenuhi. Kami selalu berfokus pada kenyamanan dan kesejahteraan Anda, memberikan perawatan yang tepat dengan profesionalisme tinggi, serta menciptakan pengalaman yang menyenangkan bagi setiap pasien.</p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					...
					<p>Konsultasikan masalah kesehatan Anda dengan dokter berpengalaman yang siap memberikan solusi terbaik.</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					...
					<p>Peralatan medis modern untuk memastikan pelayanan kesehatan yang lebih cepat, tepat, dan efektif.</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item">
					...
					<p>Dokter kami yang terlatih memberikan perhatian maksimal untuk kesehatan Anda dengan cara yang penuh empati.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-6">
				<div class="section-title text-center">
					<h2 class="mb-4">Spesialis yang Siap Membantu Anda</h2>
					<div class="divider mx-auto my-4"></div>
					<p>Perawatan terbaik dari para ahli yang berkompeten, dengan pendekatan yang memprioritaskan kenyamanan dan hasil yang optimal.</p>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="col-lg-6 testimonial-wrap offset-lg-6">
				...
				<div class="testimonial-block">
					<div class="client-info">
						<h4>Dokter yang Ahli!</h4>
						<span>Mullets</span>
					</div>
					<p>
						Para dokter di sini sangat berkompeten dan penuh perhatian. Mereka menjelaskan setiap langkah dengan jelas, membuat saya merasa aman dan nyaman.
					</p>
					<i class="icofont-quote-right"></i>
				</div>
				...
				<div class="testimonial-block">
					<div class="client-info">
						<h4>Support yang Sangat Baik!</h4>
						<span>Mario</span>
					</div>
					<p>
						Staf rumah sakit sangat responsif dan siap membantu setiap saat. Mereka benar-benar peduli dan memberikan solusi yang cepat dan efisien.
					</p>
					<i class="icofont-quote-right"></i>
				</div>
				...
				<div class="testimonial-block">
					...
					<p>
						Rumah sakit ini memiliki lingkungan yang sangat nyaman dan bersih, membuat pengalaman perawatan menjadi lebih tenang dan tidak menegangkan.
					</p>
					<i class="icofont-quote-right"></i>
				</div>
				...
				<div class="testimonial-block">
					<div class="client-info">
						<h4>Pelayanan Modern!</h4>
						<span>Dpas</span>
					</div>
					<p>
						Peralatan medis yang digunakan sangat canggih, dan pelayanan yang diberikan sangat efisien. Saya merasa mendapatkan perawatan terbaik dengan teknologi terbaru.
					</p>
					<i class="icofont-quote-right"></i>
				</div>
			</div>
