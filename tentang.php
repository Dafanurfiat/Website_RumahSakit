...
<body id="top">
    ...
    <section class="section about-page">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <h2 class="title-color">Perawatan Pribadi untuk Kehidupan Sehat Anda</h2>
                </div>
                <div class="col-lg-8">
                    <p>Kami berkomitmen untuk memberikan perawatan terbaik yang mendukung gaya hidup sehat Anda. Dengan
                        pendekatan yang personal dan penuh perhatian, kami memastikan setiap kebutuhan kesehatan Anda
                        dipenuhi. Kami selalu berfokus pada kenyamanan dan kesejahteraan Anda, memberikan perawatan yang
                        tepat dengan profesionalisme tinggi, serta menciptakan pengalaman yang menyenangkan bagi setiap
                        pasien.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item mb-5 mb-lg-0">
                        <img src="images/about/about-1.png" alt="" class="img-fluid w-100">
                        <h4 class="mt-3">Kesehatan Anak yang Terjamin</h4>
                        <p>Perawatan medis khusus untuk anak-anak dengan pendekatan yang lembut dan perhatian penuh.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item mb-5 mb-lg-0">
                        <img src="images/about/about-2.png" alt="" class="img-fluid w-100">
                        <h4 class="mt-3">Pendampingan Medis Profesional</h4>
                        <p>Konsultasikan masalah kesehatan Anda dengan dokter berpengalaman yang siap memberikan solusi
                            terbaik.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item mb-5 mb-lg-0">
                        ...
                        <h4 class="mt-3">Teknologi Medis Terkini</h4>
                        <p>Peralatan medis modern untuk memastikan pelayanan kesehatan yang lebih cepat, tepat, dan
                            efektif.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="about-block-item">
                        <img src="images/about/about-4.png" alt="" class="img-fluid w-100">
                        <h4 class="mt-3">Dokter Berkompeten dan Peduli</h4>
                        <p>Dokter kami yang terlatih memberikan perhatian maksimal untuk kesehatan Anda dengan cara yang
                            penuh empati.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="section team">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <h2 class="mb-4">Dokter Spesialis yang Siap Membantu Anda</h2>
                        <div class="divider mx-auto my-4"></div>
                        <p>Perawatan terbaik dari para ahli yang berkompeten, dengan pendekatan yang memprioritaskan
                            kenyamanan dan hasil yang optimal.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <?php 
    // Query untuk memilih hanya dokter yang memiliki gelar "Sp."
    $dokterResult = mysqli_query($conn, "SELECT * FROM dokter WHERE nama_dokter LIKE '%Sp.%'");

    while ($dokter = mysqli_fetch_assoc($dokterResult)) : ?>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team-block mb-5 mb-lg-0">
                        <!-- Menampilkan gambar dokter -->
                        <img src="images/dokter/<?= htmlspecialchars($dokter['image']) ?>"
                            alt="<?= htmlspecialchars($dokter['nama_dokter']) ?>" class="img-fluid w-100">

                        <div class="content">
                            <!-- Nama dokter yang bisa diklik untuk melihat detail -->
                            <h4 class="mt-4 mb-0">
                                <a href="dokterSingle.php?id_dokter=<?= $dokter['id_dokter'] ?>">
                                    <?= htmlspecialchars($dokter['nama_dokter']) ?>
                                </a>
                            </h4>

                            <!-- Menampilkan spesialisasi berdasarkan id_poli -->
                            <p>
                                <?php 
                        // Query untuk mendapatkan nama poli berdasarkan id_poli
                        $poli = mysqli_fetch_assoc(mysqli_query($conn, "SELECT nama_poli FROM poli WHERE id_poli = {$dokter['id_poli']}"));
                        echo htmlspecialchars($poli['nama_poli']);
                        ?>
                            </p>
                        </div>
                    </div>
